...
/scratch/ty296/CT_MPS_mini/submit_multiple_jobs.sh --L=16 --P_RANGE="0.0:1.0:20" --P_FIXED_NAME="p_ctrl" --P_FIXED_VALUE=0.0 --ANCILLA=0 --N_CHUNK_REALIZATIONS=10 --N_JOBS=200 --MEMORY=40G
