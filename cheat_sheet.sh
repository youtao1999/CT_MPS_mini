...
/scratch/ty296/CT_MPS_mini/submit_multiple_jobs.sh --L=10 --P_RANGE="0.5:1.0:5" --P_FIXED_NAME="p_ctrl" --P_FIXED_VALUE=0.4 --ANCILLA=0 --MAXDIM=50 --N_CHUNK_REALIZATIONS=5 --N_JOBS=5 --MEMORY=10G
