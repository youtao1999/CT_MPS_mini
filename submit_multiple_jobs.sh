...
# Usage: /scratch/ty296/CT_MPS_mini/submit_multiple_jobs.sh --L=10 --P_RANGE="0.0:1.0:10" --P_FIXED_NAME="p_ctrl" --P_FIXED_VALUE=0.5 --ANCILLA=0 --MAXDIM=10 --N_CHUNK_REALIZATIONS=5 --N_JOBS=10 --MEMORY=8G
